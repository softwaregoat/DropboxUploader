...
//$app = new DropboxApp("5ive2cw34se33hh", "ymoxpcm8ncis7ff", "pJzXVxcrYhAAAAAAAAAAXHBsbjLMOU1iAohF-ybTbZ29NqCSe4ikwSb-k4hySdjW");
//
...
//
//        // Upload the file to Dropbox
//        $uploadedFile = $dropbox->upload($dropboxFile, "/Test/" . $fileName, ['autorename' => true]);
//
//
//        // File Uploaded
//        echo $uploadedFile->getPathDisplay();
